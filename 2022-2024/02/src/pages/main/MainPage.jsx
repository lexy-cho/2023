    ...
    <>
      ...
      <div className='mainFaq'>
        ...
        <div className='tabNav mainCase' ref={tabRef} >
            <nav>
                <ul>
                    <li className={`${tab3 === 1 ? 'on' : ''}`}><button onClick={() => handleTab3(1)}>공통 FAQ</button></li>
                    <li className={`${tab3 === 2 ? 'on' : ''}`}><button onClick={() => handleTab3(2)}>의뢰인 FAQ</button></li>
                    <li className={`${tab3 === 3 ? 'on' : ''}`}><button onClick={() => handleTab3(3)}>치과기공소 FAQ</button></li>
                    <li className={`${tab3 === 4 ? 'on' : ''}`}><button onClick={() => handleTab3(4)}>치자이너 FAQ</button></li>
                </ul>
            </nav>
        </div>
        {/* -- */}
