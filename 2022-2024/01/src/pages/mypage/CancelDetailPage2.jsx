...
const CancelDetailPage = ({onLayoutTitleChange}) => {
  useEffect(() => {
      onLayoutTitleChange('환불 상세 내역');
  });
  return (
    <>
      <section>
                ...
                <div className='detail'>
                  <article className='myBox'>
                    ...
                    <div className='orderSts'>
                      <p>
                        취소가 완료되었습니다.
                        <em>취소일시 : 2024.04.21 12:34:56</em>
                      </p>
                    </div>
                  </article>
                  <article className='myBox'>
                  ...
                  <article className='myBox orderInfo'>
                    <h4>환불 정보</h4>
                    <div className='price'>
                      <dl><dt>환불방식</dt><dd>계좌이체</dd></dl>
                      <dl><dt>환불일시</dt><dd>2024.04.21 12:34:56</dd></dl>
                      <dl><dt>총 환불 금액</dt><dd><strong>44,000원</strong></dd></dl>
                    </div>
                  </article>
                </div>
            </div>
