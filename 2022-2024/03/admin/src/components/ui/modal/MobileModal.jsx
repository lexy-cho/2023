...
const MobileModal = ({onClose}) => {
    ...
    return (
        <div className="basicPop mobileSearchPop" id="mobileSearchPop" style={{display:'block'}}>
				<button className="btnPClose" id="mobileSearchPopClose1" onClick={() => onClose()}>닫기</button>
