...
const TitleRadio = forwardRef(({ title, list, isReset = false, onCheck, checked, isAll, onChangeCheck = () => {}, isSearch, readOnly, isHeader, addClass }, ref) => {
  ...
  return (
    <>
      ...
      <div className={`multiSSet item ${addClass ? addClass : ''} ${open ? 'open' : ''}`} ref={ref}>
        <div className="selectArea" style={{ top: 0 }}>
          <div className="item">
            {isAll && (
