...
+function ($) {
	...
	var MONTHS = ['January','February','March','April','May','June','July','August','September','October','November','December'],
		...
		//SELECTED_FORMAT = 'mmm d일, (D)', MONTH_HEAD_FORMAT = 'yyyy년 mmmm',
		SELECTED_FORMAT = 'mmm d일, (D)', MONTH_HEAD_FORMAT = 'mmmm',
			...
			this.datepicker = {
				...
				calendarHolder: {
					...
					buttons: {
						...
						btnCancel: $('<span class="dudp__button cancel">취소</span>'),
						btnOk: $('<span class="dudp__button ok">확인</span>')
					}
				}
			};
