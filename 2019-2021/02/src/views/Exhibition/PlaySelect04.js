      ...
      <React.Fragment>
        <Video open={ videoOpen } close={ closeVideo } keyclassName="">
          ...
          <div className="ctsInner">
            <div className="playSelect" id="playSelect04">
              <div className="whiteBox">
                <div className="headLine">
                  <strong>Welcome our Residential Solution Studio.</strong>
                ...
                <ul>
                  <li>
                    <span className="selectItem">
                      ...
                      <label htmlFor="playSelect011">48V</label>
                    </span>
                  </li>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect012"/>
                      <label htmlFor="playSelect012">HVS</label>
                    </span>
                  </li>
                </ul>
