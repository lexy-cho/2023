        ...
        <Video open={ videoOpen } close={ closeVideo } keyclassName="">
          ...
          <div className="ctsInner">
            <div className="exhiGate">
              <div className="exhiGateFrame">
                <strong>Battery Studio <b>On-Air</b><br/>Your Questions Answered</strong>
                <p>Come and See the Latest Innovations at Our ESS Virtual Studio</p>
                <div className="btnArea">
                  <button className="btnM white">Start without Subtitles</button>
                  <button className="btnM white">Start with Subtitles</button>
                </div>
              </div>
            </div>
          </div>
