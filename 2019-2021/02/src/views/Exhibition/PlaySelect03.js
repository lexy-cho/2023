      ...
      <React.Fragment>
        <Video open={ videoOpen } close={ closeVideo } keyclassName="">
          ...
          <div className="ctsInner">
            <div className="playSelect" id="playSelect03">
              <div className="whiteBox">
                <div className="headLine">
                  <strong>Welcome to the<br/>UPS Solution Studio.</strong>
                ...
                <ul>
                  <li>
                    <span className="selectItem">
                      ...
                      <label htmlFor="playSelect011">Cell</label>
                    </span>
                  </li>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect012"/>
                      <label htmlFor="playSelect012">Module</label>
                    </span>
                  </li>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect013"/>
                      <label htmlFor="playSelect013">Rack</label>
                    </span>
                  </li>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect014"/>
                      <label htmlFor="playSelect014">Warranty</label>
                    </span>
                  </li>
                </ul>
