      ...
      <React.Fragment>
        <Video open={ videoOpen } close={ closeVideo } keyclassName="">
          ...
          <div className="ctsInner">
            <div className="playSelect">
              <div className="whiteBox">
                <div className="headLine"><strong>Please click on the studio you want to see.</strong></div>
                <ul>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect011" checked/>
                      <label htmlFor="playSelect011">Studio1. Park: Utility/CES</label>
                    </span>
                  </li>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect012"/>
                      <label htmlFor="playSelect012">Studio2. Library: UPS</label>
                    </span>
                  </li>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect013"/>
                      <label htmlFor="playSelect013">Studio3. Home: Residential Products</label>
                    </span>
                  </li>
                  <li>
                    <span className="selectItem">
                      <input type="radio" name="playSelect01" id="playSelect014"/>
                      <label htmlFor="playSelect014">Live on-site: SBB</label>
                    </span>
                  </li>
                </ul>
