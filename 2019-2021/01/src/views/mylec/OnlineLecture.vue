              ...
              <li>
                <div class="lecBasic">
                  ...
                  <div class="choice">
                    ...
                    <span class="lecReAddSet">
                      <button disabled @click="popupTrigger6 = true">홀딩신청</button>
                      <button disabled @click="popupTrigger7 = true">연장신청</button>
                    </span>
                  </div>
                </div>
              </li>
    ...
    <Popup v-if='popupTrigger' @close="popupTrigger = false" class="courseStartPop">
      <template slot="modalheader">
        <div>
          ...
          <p>수강시작일변경은 강의가 시작하기 전까지 총 3번 변경할 수 있습니다.</p>
        </div>
      </template>
      <template slot="modalbody">
        <div>
          수강시작일 변경 횟수 <strong>2/3회</strong>
