          ...
          <div class="statusGraph">
            <div class="item takenLec">
              ...
              <dl class="numberData nD01">
                ...
                <dd>
                  <span>총 수강강의<strong>50강</strong></span>
                  <span class="wide">일 평균 수강강의<strong>3강</strong></span>
                  <span>오늘의 수강강의<em>상위<strong>13</strong>%</em></span>
                </dd>
              </dl>
            </div>
            <div class="item lecTime">
              <div class="graphArea">
                <Echart
                  :option="bar32"
                  :loading="loading"
              ...
              <dl class="numberData nD02">
                ...
                <dd>
                  <span>총 수강시간<strong>50:48</strong></span>
                  <span class="wide">일 평균 수강시간<strong>03:15</strong></span>
                  <span>오늘의 수강시간<em>상위<strong>16</strong>%</em></span>
                </dd>
              </dl>
            </div>
            <div class="item selfTime">
              ...
              <dl class="numberData nD03">
                ...
                <dd>
                  <span>총 공부 시간<strong>62:00</strong></span>
                  <span class="wide">일 평균 공부시간<strong>02:29</strong></span>
                  <span>오늘의 공부시간<em>상위<strong>11</strong>%</em></span>
                </dd>
              </dl>
            </div>
          </div>
            ...
            <div class="tabLayout">
              <div class="calTop">
                ...
                <span class="right" v-if="!this.mobile">
                  ...
                  <em class="scSet edu"><i></i>교육학 자율공부시간</em>
                </span>
              </div>
