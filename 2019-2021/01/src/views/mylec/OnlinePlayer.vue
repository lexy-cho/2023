<template lang="html">
  <div>
            ...
            <div class="frameBack">
              ...
              <div class="lecInfo">
                ...
                <div class="allDate">
                  ...
                  <span class="rate">
                    <strong>진도율</strong>
                    <span class="rateBar"><span style="width:75%;"></span><em>75/100강</em></span><em class="iMaking end">제작완료</em>
                  </span>
                </div>
                <!---->
                <div class="btn">
                  <!-- <button class="btnLecReAdd" disabled @click="popupTrigger8 = true">재수강신청</button> -->
                  <button class="btnLecReAdd" @click="popupTrigger7 = true">연장신청</button>
                  <!-- <button class="btnLecReAdd" @click="popupTrigger6 = true">홀딩신청</button> -->
                  <button class="btnLecReAdd" disabled @click="popupTrigger6 = true">홀딩불가</button>
                  <button class="btnLecReAdd" @click="popupTrigger10 = true">수강후기</button>
                ...
                <div class="tabNav">
                  <nav>
                    <ul>
                      ...
                      <li :class="{on:currentTab===1}"><button @click="gotoView(), currentTab = 1">학습 Q&amp;A</button></li>
                      <li :class="{on:currentTab===2}"><button @click="gotoView(), currentTab = 2">선생님 공지</button></li>
                    ...
                    <div class="tabNav">
                      <nav>
                        <ul>
                          ...
                          <li :class="{on:currentTab===1}"><button @click="currentTab = 1">학습 Q&amp;A</button></li>
                          <li :class="{on:currentTab===2}"><button @click="currentTab = 2">선생님 공지</button></li>
    ...
    <!-- Layer Popup -->
    <!-- 집중모드-->
    <div class="myPlayerFocusMode" v-if="myPlayerFocusModeTrigger == true">
...
export default {
  ...
  name: 'OnlinePlayer',
  components: {
    PlayerListArea,   // 일반 본창 모드
    PlayerListArea2,  // 집중 모드
    PlayerQnA,
    PlayerLectureData,
    PlayerNotice,
    PlayerBoard,
  ...
  methods: {
    ...
    gotoView() {
      ...
      var topPos = element.offsetTop - 36;
      //console.log(topPos);
      window.scrollTo({
        top: topPos,
        left: 0,
