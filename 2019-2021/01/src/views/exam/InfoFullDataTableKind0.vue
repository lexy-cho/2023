<template >
  <div>
    <h4>
      <strong>유치원</strong>의 최근 3개년 경쟁률 및 합격선
      <span class="dataKind">
    ...
    <div class="fullDataTable" v-if="type == 1">
      <table>
        <thead>
          <tr>
            <th></th>
            <th colspan="5" v-if="year == 0 || year == 1">2021학년도</th>
            <th colspan="5" v-if="year == 0 || year == 2">2020학년도</th>
            <th colspan="5" v-if="year == 0 || year == 3">2019학년도</th>
          </tr>
          <tr>
            <th>지역</th>
...
export default {
  ...
  methods: {
    ...
    onChange2(event) {
      let value = event.target.value;
      if (value == 'year00') this.year = 0;
      else if (value == 'year01') this.year = 1;
