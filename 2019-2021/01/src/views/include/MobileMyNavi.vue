    ...
    <div class="naviBack">
      ...
      <div class="naviBase">
        ...
        <div class="naviMyInfo" v-else-if="this.isLoginToggle">
          ...
          <span class="goMy">
            <router-link to="/mkup/mypage/payment/history" class="btnMypage" @click.native="mobileMynaviClose($event)">마이페이지</router-link>
      ...
      <div class="my">
        ...
        <!---->
        <div class="loginAfter" v-else-if="this.isLoginToggle">
          ...
          <div class="favoritesLec" v-if="this.isLecToggle">
            <ul class="favoritesList">
              ...
              <li>
                ...
                <button @click="isLecToggle = false">강의 없는 여부</button><br/>
