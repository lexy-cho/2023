      ...
      <article>
        ...
        <div class="academyIndex">
          ...
          <div class="mainSlogan">
            <div class="txt">
              <div class="mainTxt">
                <em data-aos="fade-up" data-aos-duration="1000"><strong>희소고시학원</strong>은</em>
                <span data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">임용고시를 준비하는 이들을 위해 노력합니다.</span>
              </div>
              <p data-aos="fade-in" data-aos-duration="1000" data-aos-delay="1600">최고의 강의, 최고의 선생님을 지금 여기서 만나보세요.</p>
            </div>
            ...
            <div class="btn" id="scrollBeforTab">
              <div class="frameBack">
                <button class="goArea01" @click="gotoSection('academyTrigger01')">강의실 배정표</button>
                <button class="goArea02" @click="gotoSection('academyTrigger02')">학원 보충강의</button>
                <button class="goArea03" @click="gotoSection('academyTrigger03')">사물함 신청</button>
                <button class="goArea04" @click="gotoSection('academyTrigger04')">스터디 하실래요</button>
                <button class="goArea05" @click="gotoSection('academyTrigger05')">학원 시설</button>
                <button class="goArea06" @click="gotoSection('academyTrigger06')">1:1 상담하기</button>
                <button class="goArea07" @click="gotoSection('academyTrigger07')">학원 위치</button>
              </div>
            </div>
            <img :src="require(`@/assets/images/img_academy_plus1.png`)" alt="" class="plusImg1"  data-aos="fade-up-left"  data-aos-delay="1200"/>
            <img :src="require(`@/assets/images/img_academy_plus2.png`)" alt="" class="plusImg2"  data-aos="fade-up-left" data-aos-delay="700" />
            <img :src="require(`@/assets/images/img_academy_plus3.svg`)" alt="" class="plusImg3"  data-aos="fade-down" data-aos-delay="50" />
          </div>
          <!-- //메인 -->
          <div class="academyTopBtn" id="scrollAfterTab">
            <div class="frameBack">
              <span :class="{on:menuTab===0}"><button class="goArea01" @click="gotoSection('academyTrigger01')"><em>강의실 배정표</em></button></span>
              <span :class="{on:menuTab===1}"><button class="goArea02" @click="gotoSection('academyTrigger02')"><em>학원 보충강의</em></button></span>
              <span :class="{on:menuTab===2}"><button class="goArea03" @click="gotoSection('academyTrigger03')"><em>사물함 신청</em></button></span>
              <span :class="{on:menuTab===3}"><button class="goArea04" @click="gotoSection('academyTrigger04')"><em>스터디 하실래요</em></button></span>
              <span :class="{on:menuTab===4}"><button class="goArea05" @click="gotoSection('academyTrigger05')"><em>학원 시설</em></button></span>
              <span :class="{on:menuTab===5}"><button class="goArea06" @click="gotoSection('academyTrigger06')"><em>1:1 상담하기</em></button></span>
              <span :class="{on:menuTab===6}"><button class="goArea07" @click="gotoSection('academyTrigger07')"><em>학원 위치</em></button></span>
            </div>
          </div>
          <!-- 강의실 배정표 -->
            ...
            <div class="frameBack">
              <div class="classRoomInfo">
                <div class="box">
                  ...
                  <p>
                    <span>강의실 확정은 전일 <em>21</em>시경 입니다. 정확한 배정은 <em>21</em>시 이후에 확인해 주세요.</span>
                    <span>사회적 거리두기 또는 학원 사정에 따라 자습실 이용이 제한될 수 있습니다.</span>
                  </p>
                </div>
              </div>
                    ...
                    <div class="tabNav">
                      <nav>
                        <ul class="blackLineTab">
                          <li :class="{on:currentTab===0}"><button @click="currentTab = 0">이데아관</button></li>
                          <li :class="{on:currentTab===1}"><button @click="currentTab = 1">아이비관</button></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
          ...
          <div class="infoAddition" id="academy02Loc" ref="academyTrigger02">
            <div class="frameBack">
              <h2><span>다 듣지 못한 강의, </span>걱정말고 <strong>보충강의</strong> 신청하세요!</h2>
              <div>
                <dl>
                  <dt class="tit01">무료보강</dt>
                  <dd>학원 수업이 진행되고 동영상 강의 업데이트가 완료된 이후 신청 가능합니다.</dd>
                  <dd>보강 신청 횟수는 2개월 강의 기준 최대 2일로 제한하며, <br/>보충강의 수강 시간은 해당 강의의 온라인 강의 수강시간과 동일합니다.</dd>
                  <dd>보강은 학원강의 종료 10일 이내 까지만 신청 가능합니다.</dd>
                  <dd>신청/승인 날짜로부터 8일간 수강 가능합니다.(8일 이후 자동 삭제)</dd>
                  <dd>보강 신청 완료 후 바로 강의가 시작되며, 내 강의실의 학원 보충 강의에서 수강 가능합니다.</dd>
                ...
                <dl>
                  ...
                  <dd>유료보강 신청 횟수는 2개월 강의 기준 최대 2일로 제한하며, <br/>보충강의 수강 시간은 해당 강의의 온라인 강의 수강시간과 동일합니다.</dd>
                  <dd>유료보강은 학원 강의 종료 후 20일 이내 까지만 신청/결제 가능합니다.</dd>
                  <dd>신청/승인 날짜로부터 8일간 수강 가능합니다.(8일 이후 자동 삭제)</dd>
                  <dd>보강은 결제 완료 후 바로 시작되며, 내 강의실의 학원 보충 강의에서 수강 가능합니다.</dd>
                  <dd>수업자료는 첨부파일로 제공됩니다.</dd>
                  <dd>결제하신 유료보강은 취소가 불가능 합니다.</dd>
                  <dd>일부 강좌(보너스 강의, 특강) 등 보충강의가 제공되지 않습니다.</dd>
                </dl>
              </div>
              <router-link to="/mkup/mylec/direct/addition" class="btnL green rnd">보충강의 신청하기</router-link>
            </div>
          </div>
          <!-- //학원 보충강의 -->
          <!-- 사물함 신청 -->
          <div class="goLocker" id="academy03Loc" ref="academyTrigger03">
            <div class="frameBack">
              <h2>학습자료의 보관!<br/> 희소고시학원 사물함에 맡겨주세요.</h2>
              <div class="box">
                <div class="bothArrows">
                  <swiper :options="swiperOption02">
                    <swiper-slide>
                      <router-link to=""><img :src="require(`@/assets/images/thumbnail/@tmp_inside_goLocker.png`)" alt="" /></router-link>
                    </swiper-slide>
                    <swiper-slide>
                      <router-link to=""><img :src="require(`@/assets/images/thumbnail/@tmp_inside_goLocker.png`)" alt="" /></router-link>
                    </swiper-slide>
                ...
                <div class="left">
                  <div>
                    ...
                    <router-link to="/mkup/mypage/payment/locker" class="btnL green rnd">사물함 신청</router-link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="panoramaTabwrap">
              ...
              <div class="tabBack">
                <div class="tabNav">
                  <nav>
                    <ul>
                      <li :class="{on:currentTab2===0}"><button @click="currentTab2 = 0">서울 이데아관</button></li>
                      <li :class="{on:currentTab2===1}"><button @click="currentTab2 = 1">서울 아이비관</button></li>
                    </ul>
                  </nav>
                </div>
              </div>
          ...
          <div class="goCounsel" id="academy06Loc" ref="academyTrigger06">
            <div class="frameBack">
              <h2>1:1 상담하기<br/> 임용에 대한 궁금증과 학습 방법을 도와드립니다.</h2>
              <div class="detail">
                <span class="item01">
                  <em>누구나 신청 가능!!</em>
                  <strong>1:1 게시판 <i>학원전문가 상담</i></strong>
                  <router-link to="/mkup/counsel/bbswrite" class="btnM rnd">바로가기</router-link>
                </span>
                <span class="item02">
                  <em>누구나 신청 가능!!</em>
              ...
              <div class="directTabwrap">
                ...
                <div class="tabBack">
                  <div class="tabNav">
                    <nav>
                      <ul class="blackLineTab">
                        <li :class="{on:currentTab3===0}"><button @click="currentTab3 = 0">서울 이데아관</button></li>
                        <li :class="{on:currentTab3===1}"><button @click="currentTab3 = 1">서울 아이비관</button></li>
                      </ul>
                    </nav>
                  </div>
                </div>
  ...
  data() {
    return {
      ...
      swiperOption02: {
        ...
        speed: 1500,
        autoplay: true,
        navigation: { nextEl: '.goLocker .swiper-button-next', prevEl: '.goLocker .swiper-button-prev' },
      },
    }
  },
  methods: {
